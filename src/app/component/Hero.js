...
// import { Vortex } from "./_comp/Vortex";
        ...
        return (
            <div className="relative h-[90vh] w-full flex items-center">
                ...
                <div className="w-1/2 h-full  flex items-center justify-center flex-col z-10">
                    ...
                    {/* <button className="w-30 border-2 text-black font-medium rounded-lg transition-all transform hover:scale-105">
            Get Started
          </button> */}
                    <div className="mt-10">
                    ...
                    >
                        <Card className="bg-white overflow-hidden ">
                            <div className="absolute bottom-0 mx-auto bg-white/30 backdrop-blur text-center ml-[2%] w-[96%] mb-[2%] rounded-md text-black">
                                ...
                                <p className=" mb-4">Elect interview topics based on specific technologies, company requirements, or subjects like DBMS, OS, and CN. Vigilant mode with webcam for integrity in anticipation years. Empowering students with autonomy.</p>
                            </div>
                            <div className="w-full h-full -z-10">
                                <img className=" inset-0 w-full h-full object-cover rounded-md" src="./2.png" alt="AI interviewing a student" />
                            </div>
                        </Card>
                        <Card className="bg-white overflow-hidden ">
                            <div className="absolute bottom-0 mx-auto bg-white/30 backdrop-blur text-center ml-[2%] w-[96%] mb-[2%] rounded-md text-black">
                                <h3 className="text-2xl font-bold mb-3">AI-Powered Practice for Interviews & Viva</h3>
                                <p className=" mb-4">Prepare for technical interviews, HR rounds, and viva examinations across various domains with Intervue's generative AI. Practice real questions without a human interviewer.</p>
                            </div>
                            <div className="w-full h-full -z-10">
                                <img className=" inset-0 w-full h-full object-cover rounded-md" src="./3.png" alt="AI interviewing a student" />
                            </div>
                        </Card>
                        <Card className="bg-white overflow-hidden ">
                            <div className="absolute bottom-0 mx-auto bg-white/30 backdrop-blur text-center ml-[2%] w-[96%] mb-[2%] rounded-md text-black">
                                <h3 className="text-2xl font-bold mb-3">Personalized Feedback & Improvement</h3>
                                <p className=" mb-4">Our LLM evaluates your responses, scores answers, and provides detailed feedback, highlighting your weaknesses. Get intelligent recommendations for tutorials, videos, and topic-based improvement tips.</p>
                            </div>
                            <div className="w-full h-full -z-10">
                                <img className=" inset-0 w-full h-full object-cover rounded-md" src="./1.png" alt="AI interviewing a student" />
                            </div>
                        </Card>
                    </CardSwap>
                </div>
